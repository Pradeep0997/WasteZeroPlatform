    ...
    <div className="h-screen flex flex-col lg:flex-row overflow-hidden">
      ...
      <div className="w-full lg:w-1/2 bg-gray-50 dark:bg-gray-900 flex flex-col h-screen">
        <div className="flex-shrink-0 p-4 lg:p-6 pb-2 bg-gray-50 dark:bg-gray-900 border-b border-gray-200 dark:border-gray-700">
          {/* WasteZero Brand Link — navigates back to landing page */}
          <div className="flex justify-center mb-3">
            <button
              onClick={() => navigate('/')}
              className="flex items-center gap-2 group focus:outline-none"
              aria-label="Go to WasteZero home"
            >
              <div className="w-8 h-8 bg-[#588157]/10 dark:bg-[#588157]/20 rounded-lg flex items-center justify-center border border-[#588157]/30 group-hover:bg-[#588157]/20 transition-colors">
                <img src="/logo.webp" alt="WasteZero logo" className="w-5 h-6" />
              </div>
              <span className="text-lg font-bold text-[#588157] dark:text-green-400 group-hover:text-[#4f685b] dark:group-hover:text-green-300 transition-colors tracking-tight">
                WasteZero
              </span>
            </button>
          </div>
          <div className="flex bg-gray-200 dark:bg-gray-800 rounded-lg p-1 w-full max-w-sm mx-auto">
            <button
              ...
              className={`w-1/2 p-2 rounded-md font-semibold transition-all ${isLogin
            ...
            {!isLogin && !isOtpStep && (
              <>
                ...
                <form className="space-y-3 pb-6" onSubmit={handleRegisterSubmit}>
                  ...
                  <div>
                    <label htmlFor="register-role" className="block text-sm font-medium text-gray-600 dark:text-gray-300 mb-1">
                      Role
                    </label>
                    <select
                      id="register-role"
