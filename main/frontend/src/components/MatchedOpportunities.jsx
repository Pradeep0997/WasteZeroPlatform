...
export default function MatchedOpportunities({ onApply, loading: parentLoading, appliedIds = [] }) {
          ...
          >
            ...
            {expandedCard === match.opportunity._id && (
              <div className="mt-4 pt-4 border-t border-gray-300 dark:border-gray-600">
                      ...
                      <div className="flex items-center mt-1">
                        <div className="w-full bg-gray-200 dark:bg-gray-700 rounded-full h-2">
                          <div
                            ...
                            className={`h-2 rounded-full ${reason === 'location' ? 'bg-red-500' :
                ...
                <button
                  ...
                  disabled={match.opportunity.status !== 'active' || match.opportunity.isFull || appliedIds.includes(match.opportunity._id)}
                ...
                >
                  {appliedIds.includes(match.opportunity._id) ? 'Already Applied' : (match.opportunity.isFull ? 'Opportunity Full' : 'Apply Now')}
                </button>
              </div>
            )}
            ...
            {expandedCard !== match.opportunity._id && (
              <div className="mt-4 pt-3 border-t border-gray-200 dark:border-gray-700 flex items-center justify-between">
                ...
                >
                  {appliedIds.includes(match.opportunity._id) ? 'Applied' : (match.opportunity.isFull ? 'Full' : 'Quick Apply')}
                </button>
